import fresh_tomatoes     # importing fresh_tomatoes
import mypage
...
midnight_in_paris = mypage.Movie(
                   ...
                   "https://vignette.wikia.nocookie.net/midnightinparis/images/a/a9/Midnight-in-paris-header.jpg/revision/latest?cb=20130424031150",
                   "https://www.youtube.com/watch?v=FAfR8omt-CY")

hunger_games = mypage.Movie(
                   "Hunger Games",
                   "A really reality real show ",
                   "https://vignette.wikia.nocookie.net/dietributevonpanem/images/a/a5/250px-O-FINAL-HUNGER-GAMES-POSTER-570.jpg/revision/latest?cb=20120401064801&path-prefix=de",
                   "https://www.youtube.com/watch?v=4S9a5V9ODuY")

gangs_of_ny = mypage.Movie(
                    "Gangs of New York",
                    "Amsterdam returns to Five Points to get revenge on his father's killer",
...
pulp_fiction = mypage.Movie(
                    "Pulp Fiction",
                    "Storylines of mobsters, fringe players, small-time criminals, and a mysterious briefcase",
                    "https://upload.wikimedia.org/wikipedia/en/3/3b/Pulp_Fiction_%281994%29_poster.jpg",
                    "https://www.youtube.com/watch?v=tGpTpVyI_OQ")

divergent = mypage.Movie(
                    "Divergent",
                    "A thrilling action-adventure film set in a world where people are divided into distinct factions based on human virtues.",
                    "https://upload.wikimedia.org/wikipedia/en/d/d4/Divergent.jpg",
                    "https://youtu.be/336qJITnDi0")

insurgent = mypage.Movie(
                   "The Divergent Series: Insurgent",
                   "Insurgent raises the stakes for Tris as she searches for allies and answers in the ruins of a futuristic Chicago.",
...
ascendant = mypage.Movie(
                  ...
                  "http://www.thedivergentseries.movie/ascendant/assets/img/poster/poster.jpg",
...
interstellar = mypage.Movie(
                  ...
                  "https://vignette.wikia.nocookie.net/interstellarfilm/images/6/6f/Interstellar_website.jpg/revision/latest?cb=20140923050808",
                  "https://www.youtube.com/watch?v=zSWdZVtXT7E")

#  Code Array, Array python LIST
movies = [toy_story, avatar, school_of_rock, rotatouille, midnight_in_paris, hunger_games, gangs_of_ny, pulp_fiction, divergent, insurgent, allegiant, ascendant, star_trek, star_trek_into_darkness, interstellar]
#  Display the moie page!
